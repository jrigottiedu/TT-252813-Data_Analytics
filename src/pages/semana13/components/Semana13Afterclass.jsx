    ...
    <div>
      ...
      <section className="home-info-container">
        ...
        <ul className='list-disc list-inside'>
          ...
          <li>Les dejo un link con documentación oficial para quienes deseen profundizar en el tema <a href="https://plotly.com/python/bar-charts/" target='_blank' className='link'>Documentación Plotly</a></li>
