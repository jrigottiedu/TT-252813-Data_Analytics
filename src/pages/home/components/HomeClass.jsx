        ...
        <div className='home-info-container'>
            <div className="flex flex-col items-start w-full">
                ...
                <ul className='space-y-1 pt-2'>
                    ...
                    <li><strong>Modalidad: </strong>Virtual por Zoom <a className='link' href="https://us02web.zoom.us/j/88410146846" target="_blank">Click aquí</a></li>
                    ...
                    <li><strong>Clases grabadas: </strong>Lista de reproducción en Youtube - <a href="https://www.youtube.com/playlist?list=PLR6qrffywxhCXbifXL6lB9zh0nbI5e9hU" target="_blank" className='link'>Click aquí</a></li>
                </ul>
            </div>
        </div>
    )
